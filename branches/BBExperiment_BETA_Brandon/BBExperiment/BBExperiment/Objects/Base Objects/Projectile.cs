...
namespace BBN_Game.Objects
{
    class Projectile : DynamicObject
    {
        ...
        public Projectile(Game game, StaticObject parent, Boolean left)
            : base(game, Objects.Team.neutral, parent.Position + (left ? Vector3.Transform(new Vector3(-parent.getBoundingSphere().Radius, 0, 0), Matrix.CreateFromQuaternion(parent.rotation)) : Vector3.Transform(new Vector3(parent.getBoundingSphere().Radius, 0, 0), Matrix.CreateFromQuaternion(parent.rotation))))
        {
            this.Health = 10;
            numHudLines = 3;
