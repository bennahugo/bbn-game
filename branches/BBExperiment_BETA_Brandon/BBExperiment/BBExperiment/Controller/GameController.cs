...
namespace BBN_Game.Controller
{
    ...
    class GameController
    {
        ...
        static List<Objects.StaticObject> AllObjects, DynamicObjs, Asteroids, Projectiles, targets;
        
        static Objects.playerObject Player1;

        public static List<Objects.StaticObject> getProjectiles
        {
        ...
        public static List<Objects.StaticObject> Targets
        {
            get { return targets; }
        }
        #endregion
        ...
        protected void loadMap(string mapName)
        {
            ...
            //gameGrid = new BBN_Game.Grid.GridStructure(1000, GRID_CUBE_SIZE);
