...
namespace BBN_Game.Objects
{
    ...
    class StaticObject : DrawableGameComponent, Grid.GridObjectInterface
    {
        ...
        public virtual void LoadContent()
        {
            ...
            targetBoxDecleration = new VertexDeclaration(VertexPositionColor.VertexDeclaration.GetVertexElements());
            #endregion
        ...
        private void drawBox(Vector2 screenViewport)
        {
            ...
            targetBoxE.Techniques[0].Passes[0].Apply();
            ...
            GraphicsDevice.SetVertexBuffer(targetBoxVB);
