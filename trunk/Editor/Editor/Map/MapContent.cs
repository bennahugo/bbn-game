...
namespace BBN_Game.Map
{
    ...
    class MapContent
    {
        ...
        /// Update method
        /// </summary>
        /// <param name="keyboard">keybord control state</param>
        /// <param name="GP1">game pad 1 state</param>
        /// <param name="GP2">game pad 2 state</param>
        public virtual void update(KeyboardState keyboard, GamePadState GP1, GamePadState GP2)
        ...
        public virtual void Draw(Matrix view, Matrix Projection, Vector3[] Lighting, Vector3 fogColour, int[] fogVariables)
        { /*Override in children*/ }
    }
}
