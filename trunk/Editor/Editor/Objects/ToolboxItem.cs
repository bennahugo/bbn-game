...
namespace BBN_Game.Objects
{
    ...
    class ToolboxItem
    {
        ...
        /// <summary>
        /// Stores whether the object should be static or dynamic (this is informatory, so that the correct
        /// object instance may be created by the engine)
        /// </summary>
        public bool movableObject { get; private set; }
        /// <summary>
        ...
        public ToolboxItem(String name, String type, bool movableObject)
        {
