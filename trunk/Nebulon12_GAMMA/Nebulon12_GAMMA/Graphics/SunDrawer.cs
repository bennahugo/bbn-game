...
namespace BBN_Game.Graphics
{
    class SunDrawer
    {
        ...
        public SunDrawer(Vector3 p1, Vector3 p2, Vector3 p3, Vector3 p4,Game game)
        {
            ...
            sun = new Graphics.Shapes.QuadDrawer(p1 + new Vector3(0.01f, 650, 650), p2 + new Vector3(0.01f, -650, 650), p3 + new Vector3(0.01f, 650, -650), p4 + new Vector3(0.01f, -650, -650),
                1, tBack, game.GraphicsDevice);
            glare = new Graphics.Shapes.QuadDrawer(p1 + new Vector3(0.01f, 0, 0), p2 + new Vector3(0.01f, 0, 0), p3 + new Vector3(0.01f, 0, 0), p4 + new Vector3(0.01f, 0, 0), 
        ...
        public void draw(Matrix world, Camera.CameraMatrices cam, GraphicsDevice g)
        {
            ...
            e.AmbientLightColor = new Vector3(1f, 0.8f, 0.7f);
